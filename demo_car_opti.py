...
from draw import Draw_MPC_point_stabilization_v2
...
if __name__ == '__main__':
    ...
    opti.subject_to(opti.bounded(-3.0, y, 3.0))
    ...
    final_state = np.array([2, 1.5, 0.0])
    ...
    draw_result = Draw_MPC_point_stabilization_v2(
        rob_diam=0.3, init_state=init_state, target_state=final_state, robot_states=xx, control_states=u_c)
